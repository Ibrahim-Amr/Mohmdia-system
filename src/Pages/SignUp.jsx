...
const SignUp = () => {
	...
	async function handleSubmit(e) {
		...
		try {
			...
			formDataCopy.avatar = user.photoURL;
	...
	return (
		<>
			<section className='container mx-auto'>
				{/* <!-- component --> */}
				<div class='min-w-screen min-h-[calc(100vh-60px)]  flex items-center justify-center px-5 py-5'>
					<div class='bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden max-w-[1000px]'>
									...
									<div>
										<div class='flex -mx-3'>
											<div class='w-full px-3 mb-5'>
												<label for='name' class='text-xs font-semibold px-1'>
													Name
												</label>
												<div class='flex'>
													<div class='w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center'>
														<HiOutlineUser className='text-gray-400 text-lg w-5 h-5' />
													</div>
													<input
														type='text'
														id='name'
										...
										<div class='flex -mx-3'>
											<div class='w-full px-3 mb-5'>
												...
												<div class='flex'>
													<div class='w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center'>
														<HiOutlineMail className='text-gray-400 text-lg w-5 h-5' />
													</div>
													<input
														type='email'
														id='email'
										...
										<div class='flex -mx-3'>
											<div class='w-full px-3 mb-5'>
												...
												<div class='flex'>
													<div class='w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center'>
														<MdLockOutline className='text-gray-400 text-lg w-5 h-5' />
													</div>
													<input
														type='password'
														id='password'
